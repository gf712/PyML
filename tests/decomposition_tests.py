...
class PCATest(unittest.TestCase):
    ...
    def test_PCA_eigenvalues(self):
        self.assertCountEqual(self.decomposer.eigenvalues,
                              [4.1966751631979795, 0.24062861448333198,
                               0.07800041537352681, 0.023525140278494793])

    def test_PCA_eigenvectors(self):
        self.assertAlmostEqual(self.decomposer.eigenvectors[0][2],
                               0.5809972798275975)

    def test_PCA_transform(self):
        self.assertAlmostEqual(self.decomposer.transform(self.X)[1][2],
                               0.203521425006)

    def test_PCA_train_transform(self):
        self.assertAlmostEqual(self.decomposer.train_transform(self.X)[1][2],
                               0.203521425006)
    ...
    def test_PCA_explained_var(self):
        self.assertAlmostEqual(self.decomposer.explained_variance[0],
                               4.1966751631979795)

    def test_PCA_explained_var_ratio(self):
        self.assertAlmostEqual(self.decomposer.explained_variance_ratio[0],
                               0.9246162071742684)
