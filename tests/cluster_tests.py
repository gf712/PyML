...
class KMeansTest(unittest.TestCase):
    ...
    def test_KMeansCentroids(self):
        self.assertAlmostEqual(self.classifier.centroids[1][1],
                               0.21926563270201577)

    def test_KMeansPredict(self):
        self.assertListEqual(self.classifier.predict(self.X_test),
                             [0, 0, 1, 1, 0, 1, 0, 0, 2, 2, 0, 1, 0, 0, 1])
    ...
    def test_KMeans_Norm_Error(self):
        self.assertRaises(ValueError, KMeans, 1, 'forgy', 100, 1, None,
                          'amazing norm')
    ...
    def test_KMeans_l2(self):
        datapoints, labels = gaussian(n=100, d=2, labels=3, sigma=0.1,
                                      seed=1970)
